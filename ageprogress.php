 ...
 *
function ageprogress_civicrm_preProcess($formName, &$form) {
 ...
 *
function ageprogress_civicrm_navigationMenu(&$menu) {
  _ageprogress_civix_insert_navigation_menu($menu, 'Mailings', array(
  ...
  _ageprogress_civix_navigationMenu($menu);
} // */
