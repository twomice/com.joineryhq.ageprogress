 ...
 */
class CRM_Ageprogress_Upgrader_Base {

  /**
   * @var CRM_Ageprogress_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Ageprogress_Upgrader(
   ...
   *
   * ```
   * CRM_Ageprogress_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Ageprogress_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
